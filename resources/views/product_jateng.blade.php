        ...
        <div class="container py-5">
            ...
            <div class="row">
                <div class="col align-self-center">
                    <a href="">
                        <img src="{{ asset('assets/files/pictures/SEMARANG.jpg') }}" class="rounded h-100 w-100" alt="...">
                    </a>
                </div>
                <div class="col">
                    <a href="">
                        <img src="{{ asset('assets/files/pictures/SALATIGA.jpg') }}" class="rounded h-100 w-100" alt="...">
                    </a>
                </div>
                <div class="col">
                    <a href="">
                        <img src="{{ asset('assets/files/pictures/PEKALONGAN.webp') }}" class="rounded h-100 w-100" alt="...">
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="rounded-3">
        <div class="container">
            <div class="row">
                <div class="col align-self-center">
                    <a href="">
                        <img src="{{ asset('assets/files/pictures/MAGELANG.jpg') }}" class="rounded h-100 w-100" alt="...">
                    </a>
                </div>
                <div class="col">
                    <a href="">
                        <img src="{{ asset('assets/files/pictures/SURAKARTA.jpg') }}" class="rounded h-100 w-100" alt="...">
                    </a>
                </div>
                <div class="col">
                    <a href="">
